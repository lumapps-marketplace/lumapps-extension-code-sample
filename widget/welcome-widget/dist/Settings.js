...
define('Settings', ['react', '@lumx/react', 'lumapps-sdk-js'], function (
        ...
        var deferred,
            __webpack_modules__ = {
                ...
                242: function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
                    ...
                    const WithIntlSettings = (_ref) => {
                            let { properties: properties = {}, exportProp: exportProp } = _ref;
                            const intl = useIntl(),
                                FONT_SIZES = [
                                    { label: '16px', value: 16 },
                                    { label: '18px', value: 18 },
                                ...
                                COMA_POSITION = [
                                    { label: 'settings.coma_position.before', value: 'before' },
                                    { label: 'settings.coma_position.after', value: 'after' },
                                ],
                                [displayWelcome, setDisplayWelcome] = (0, external_react_.useState)(
                                    properties.displayWelcome || !1,
                                ),
                                [isOpenFontSize, setOpenFontSize] = (0, external_react_.useState)(!1),
                                [isOpenComaPosition, setOpenComaPosition] = (0, external_react_.useState)(!1),
                                [fontSize, setFontSize] = external_react_default().useState(
                                    properties.fontSize || FONT_SIZES[0],
                                ),
                                [comaPosition, setComaPosition] = external_react_default().useState(
                                    properties.comaPosition || COMA_POSITION[1],
                                ),
                                closeSelectFontSize = () => setOpenFontSize(!1),
                                closeSelectComaPosition = () => setOpenComaPosition(!1);
                            return (
                                ...
                                external_react_default().createElement(
                                    ...
                                    external_react_default().createElement(
                                        react_.Switch,
                                        { isChecked: displayWelcome, onChange: setDisplayWelcome },
                                        external_react_default().createElement(message, { id: 'settings.time_of_day' }),
                                    ),
                                    external_react_default().createElement(
                                        react_.Select,
                                        {
                                            ...
                                            onInputClick: () => setOpenFontSize(!isOpenFontSize),
                                                ...
                                                return external_react_default().createElement(
                                                    react_.ListItem,
                                                    {
                                                        ...
                                                        onItemSelected:
                                                            ((item = size),
                                                            () => {
                                                                setFontSize(item), closeSelectFontSize();
                                                            }),
                                    ...
                                    external_react_default().createElement(
                                        react_.Select,
                                        {
                                            ...
                                            onInputClick: () => setOpenComaPosition(!isOpenComaPosition),
                                                ...
                                                return external_react_default().createElement(
                                                    react_.ListItem,
                                                    {
                                                        ...
                                                        onItemSelected:
                                                            ((item = position),
                                                            () => {
                                                                setComaPosition(item), closeSelectComaPosition();
                                                            }),
                                                        size: react_.Size.tiny,
                                                    },
                                                    external_react_default().createElement(message, {
                                                        id: position.label,
                                                    }),
                                                );
                                                var item;
